...
- [msime](https://github.com/metasequoiaime/msime)：多平台客户端仓库（原 MSIME-Apple），包含 macOS、iOS、Linux、Android 与 HarmonyOS 的原生宿主。macOS 与 iOS 已开放公开测试；macOS 使用 InputMethodKit 与 AppKit，iOS 提供宿主 App 与键盘扩展。
- [msime/platforms/linux](https://github.com/metasequoiaime/msime/tree/main/platforms/linux)：Linux 前端，正在开发中，基于 IBus 与 Fcitx5。原 MSIME-Linux 仓库已归档，保留历史与已有 Release。
