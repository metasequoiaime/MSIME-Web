...
const PLATFORMS = [
  ...
  { name: "macOS 12+", desc: "提供安装包与使用指南", status: "公开测试", isLive: true },
  { name: "Linux", desc: "适用于使用 IBus 的桌面环境", status: "开发中", isLive: false },
  { name: "iOS", desc: "通过 TestFlight 安装", status: "公开测试", isLive: true },
] as const;
